...
export const aboutUsTemplate = () => html` <section class="about-us">
  <style>
    #site {
      background: url(../../../src/styles/images/about-us.png);
    ...
    @media (width <= 600px) {
      #site {
        ...
        background-position: center 156em;
        background-repeat: no-repeat;
      }
    }
  </style>
  <div class="about-us-section">
    <div class="about-us-title about-us-title-1">
      <h1>WE</h1>
      <h1>ARE</h1>
      <h1>ABOUT</h1>
      <h1>SAVING</h1>
    ...
    <div class="about-us-title about-us-title-2">
      <h1>WE</h1>
      <h1>ARE</h1>
      <h1>ABOUT</h1>
      <h1>CREATING</h1>
...
export async function aboutUsPage(ctx) {
